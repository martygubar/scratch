...
select 
        ...
        case  
            when (paid_m1 + paid_m2 + paid_m3) / nullif((views_m1 + views_m2 + views_m3),0) - (paid_m2 + paid_m3 + paid_m4) / nullif((views_m2 + views_m3 + views_m4),0) > 0 then 'up'
            when (paid_m1 + paid_m2 + paid_m3) / nullif((views_m1 + views_m2 + views_m3),0) - (paid_m2 + paid_m3 + paid_m4) / nullif((views_m2 + views_m3 + views_m4),0) < 0 then 'down'
            else 'flat'
        end paid_ratio_m1_trend,        
        case  
            when (paid_m2 + paid_m3 + paid_m4) / nullif((views_m2 + views_m3 + views_m4),0) - (paid_m3 + paid_m4 + paid_m5) / nullif((views_m3 + views_m4 + views_m5),0) > 0 then 'up'
            when (paid_m2 + paid_m3 + paid_m4) / nullif((views_m2 + views_m3 + views_m4),0) - (paid_m3 + paid_m4 + paid_m5) / nullif((views_m3 + views_m4 + views_m5),0) < 0 then 'down'
            else 'flat'
        end paid_ratio_m2_trend,
        case  
            when (paid_m3 + paid_m4 + paid_m5) / nullif((views_m3 + views_m4 + views_m5),0) - (paid_m4 + paid_m5 + paid_m6) / nullif((views_m4 + views_m5 + views_m6),0) > 0 then 'up'
            when (paid_m3 + paid_m4 + paid_m5) / nullif((views_m3 + views_m4 + views_m5),0) - (paid_m4 + paid_m5 + paid_m6) / nullif((views_m4 + views_m5 + views_m6),0) < 0 then 'down'
            else 'flat'
        end paid_ratio_m3_trend,
        case  
        ...
        case  
            when (discount_m1 + discount_m2 + discount_m3) / nullif((views_m1 + views_m2 + views_m3),0) - (discount_m2 + discount_m3 + discount_m4) / nullif((views_m2 + views_m3 + views_m4),0) > 0 then 'up'
            when (discount_m1 + discount_m2 + discount_m3) / nullif((views_m1 + views_m2 + views_m3),0) - (discount_m2 + discount_m3 + discount_m4) / nullif((views_m2 + views_m3 + views_m4),0) < 0 then 'down'
            else 'flat'
        end discount_ratio_m1_trend,        
        case  
            when (discount_m2 + discount_m3 + discount_m4) / nullif((views_m2 + views_m3 + views_m4),0) - (discount_m3 + discount_m4 + discount_m5) / nullif((views_m3 + views_m4 + views_m5),0) > 0 then 'up'
            when (discount_m2 + discount_m3 + discount_m4) / nullif((views_m2 + views_m3 + views_m4),0) - (discount_m3 + discount_m4 + discount_m5) / nullif((views_m3 + views_m4 + views_m5),0) < 0 then 'down'
            else 'flat'
        end discount_ratio_m2_trend,
        case  
            when (discount_m3 + discount_m4 + discount_m5) / nullif((views_m3 + views_m4 + views_m5),0) - (discount_m4 + discount_m5 + discount_m6) / nullif((views_m4 + views_m5 + views_m6),0) > 0 then 'up'
            when (discount_m3 + discount_m4 + discount_m5) / nullif((views_m3 + views_m4 + views_m5),0) - (discount_m4 + discount_m5 + discount_m6) / nullif((views_m4 + views_m5 + views_m6),0) < 0 then 'down'
            else 'flat'
        end discount_ratio_m3_trend,        
        case 
            when views_m3 > 0 and
                 views_m4 > 0 and
                 views_m5 > 0 and
                 ...
                 views_m7 > 0 and
                 views_m8 > 0 and
                 views_m1 = 0 then 1 -- churner if 6 months of activity and then none
            else 0
        end is_churner
...
update custsales
set day_id = add_months(day_id, -3)
...
WITH profile as (
    ...
    and c.insuff_funds_incidents > 0
    and c.action_adventure > 25
    and cust_id not in (select cust_id from nov_churners)
)
...
-- Move their purchases back 2 months
update custsales
set day_id = add_months(day_id, -2)
...
from agg_base
where cust_id in (select cust_id from churn_sample);
